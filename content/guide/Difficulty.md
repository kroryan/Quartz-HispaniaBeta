---
title: Difficulty
description: How Easy, Normal and Hard change the game — loss scaling, safety nets and how forgiving the realm is.
tags:
  - guide
---
...
```mermaid
flowchart TD
    D{Difficulty} -->|Easy| A[Smaller losses · extra mercy<br/>in crises & extinction]
    D -->|Normal| B[Balanced losses · limited mercy]
    D -->|Hard| C[Bigger losses · no safety nets]
```
