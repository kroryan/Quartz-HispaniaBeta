---
title: Intrigue and Schemes
description: The shadow side of rule — hooks, plots, seduction, and long schemes against your rivals and your liege.
tags:
  - court
---
...
```mermaid
flowchart TD
    A[Choose a target & scheme] --> B[Odds depend on your intrigue<br/>vs their intrigue & influence]
    B --> C{Success?}
    C -->|yes| D[✅ Gold, a relic, a rival<br/>removed or weakened]
    C -->|no| E[⚠️ Scandal, lost loyalty,<br/>plots against you]
```
