...
```mermaid
flowchart TD
    A[Only swiping cards,<br/>never governing] --> B[Turns pass without<br/>real action]
    B --> C[⚠️ Court grows restless]
    C --> D[Loyalty & stability suffer]
    E[Genuinely govern:<br/>build · wage war · appoint ·<br/>manage a house] --> F[✅ Court reassured]
    F -.->|resets the clock| A
```
