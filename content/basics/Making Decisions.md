...
description: How card choices work — the two options, the advisor hint, hidden long-term pressure, and quick reactions.
tags:
  - basics
---
...
```mermaid
flowchart TD
    C[Card] --> Q1[Who is asking?]
    C --> Q2[What do they want?]
    C --> Q3[Which Power does<br/>each choice move?]
    Q1 & Q2 & Q3 --> D[Choose the option that<br/>protects your weakest Power<br/>and your long game]
```
